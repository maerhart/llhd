...
// CHECK-SAME: %[[ARGTABLE:.*]]: !llvm<"[2 x i32]*">
// CHECK-NEXT: %[[GIND0:.*]] = llvm.mlir.constant(0 : i32) : !llvm.i32
// CHECK-NEXT: %[[GIND1:.*]] = llvm.mlir.constant(0 : i32) : !llvm.i32
// CHECK-NEXT: %[[GEP0:.*]] = llvm.getelementptr %[[ARGTABLE]][%[[GIND0]], %[[GIND1]]] : (!llvm<"[2 x i32]*">, !llvm.i32, !llvm.i32) -> !llvm<"i32*">
// CHECK-NEXT: %[[L0:.*]] = llvm.load %[[GEP0]] : !llvm<"i32*">
// CHECK-NEXT: %[[GIND2:.*]] = llvm.mlir.constant(1 : i32) : !llvm.i32
// CHECK-NEXT: %[[GEP1:.*]] = llvm.getelementptr %[[ARGTABLE]][%[[GIND0]], %[[GIND2]]] : (!llvm<"[2 x i32]*">, !llvm.i32, !llvm.i32) -> !llvm<"i32*">
...
// CHECK-SAME: %[[ARGTABLE:.*]]:  !llvm<"[1 x i32]*">
// CHECK-NEXT: %[[GIND0:.*]] = llvm.mlir.constant(0 : i32) : !llvm.i32
// CHECK-NEXT: %[[GIND1:.*]] = llvm.mlir.constant(0 : i32) : !llvm.i32
// CHECK-NEXT: %[[GEP0:.*]] = llvm.getelementptr %[[ARGTABLE]][%[[GIND0]], %[[GIND1]]] : (!llvm<"[1 x i32]*">, !llvm.i32, !llvm.i32) -> !llvm<"i32*">
// CHECK-NEXT: %[[L0:.*]] = llvm.load %[[GEP0]] : !llvm<"i32*">
